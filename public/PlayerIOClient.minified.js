...
(function () {
    _pio.channel = function () { }; _pio.channel.prototype.call = function (b, g, c, d, a) {
        var e = "undefined" != typeof PLAYERIO_API_HOST ? PLAYERIO_API_HOST : (PlayerIO.useSecureApiRequests ? "https" : "http") + "://api.playerio.com/json/", f = new XMLHttpRequest; "withCredentials" in f ? f.open("post", e, !0) : "undefined" != typeof XDomainRequest ? (f = new XDomainRequest, f.open("post", e)) : f = new _pio.flashWebRequest("post", e); var h = Error(); null != f ? (f.send("[" + b + "|" + (this.token || "") + "]" + JSON.stringify(g)), f.onload = function () {
            var e =
                null; try { var g = f.response || f.responseText; if ("[" == g[0]) { var b = g.indexOf("]"); this.token = g.substring(1, b); g = g.substring(b + 1) } e = JSON.parse(g) } catch (t) { _pio.handleError(h, d, PlayerIOErrorCode.GeneralError, "Error decoding response from webservice: " + t); return } if ("undefined" == typeof e.errorcode && "undefined" == typeof e.message) { g = e; if (a) try { g = a(e) } catch (t) { _pio.handleError(h, d, PlayerIOErrorCode.GeneralError, t.message) } c && c(g) } else _pio.handleError(h, d, e.errorcode, e.message)
        }, f.onerror = function (a) {
            _pio.handleError(h,
                d, PlayerIOErrorCode.GeneralError, "Error talking to webservice: " + JSON.stringify(a))
        }) : _pio.handleError(h, d, PlayerIOErrorCode.GeneralError, "Need to implement flash calling")
    }; _pio.runCallback = function (b, g, c) { try { b && b(g) } catch (d) { b = "Unhandled error in callback: " + d.message, b = b + "\nStack:\n" + (d.stack || d.stacktrace || d.StackTrace), c && (b = b + "\nCallsite stack:\n" + (c.stack || c.stacktrace || c.StackTrace)), console.log(b) } }; _pio.handleError = function (b, g, c, d) {
        c = _pio.error(c, d); b && (b.stack && (c.stack = b.stack), b.stacktrace &&
            (c.stacktrace = b.stacktrace), b.StackTrace && (c.StackTrace = b.StackTrace)); g ? _pio.runCallback(g, c, b) : "undefined" != typeof console ? console.log("No error callback specified for: " + c.code + ": " + c.message + "\n" + (c.stack || c.stacktrace || c.StackTrace)) : alert("No error callback specified for: " + c.code + ": " + c.message + "\n" + (c.stack || c.stacktrace || c.StackTrace))
    }; _pio.error = function (b, g) {
        1 == arguments.length && (g = b, b = PlayerIOErrorCode.GeneralError); "number" == typeof b && (b = PlayerIOErrorCode.codes[b]); if ("string" != typeof b) throw console.log(b,
            g, Error().stack), "Code must be a string!"; var c = Error(); return new PlayerIOError(b, g, c.stack || c.stacktrace || c.StackTrace)
    }; _pio.debugLog = function (b) { "undefined" != typeof console && console.log(b) }; _pio.convertToKVArray = function (b) { var g = []; if (b) for (var c in b) g.push({ key: "" + c, value: "" + b[c] }); return g }; _pio.convertFromKVArray = function (b) { var g = {}; if (b && b.length) for (var c in b) g[b[c].key] = b[c].value; return g }; _pio.convertToSegmentArray = function (b) { var g = []; if (b) for (var c in b) g.push(c + ":" + b[c]); return g }
})();
PlayerIO = {
    useSecureApiRequests: !1, authenticate: function (b, g, c, d, a, e) {
        if ("auto" == c.publishingnetworklogin) "undefined" == typeof window.PublishingNetwork ? e(new PlayerIOError(PlayerIOErrorCode.GeneralError, "Could not find the PublishingNetwork object on the current page. Did you include the PublishingNetwork.js script?")) : PublishingNetwork.dialog("login", { gameId: b, connectionId: g, __use_usertoken__: !0 }, function (c) {
            c.error ? e(new PlayerIOError(PlayerIOErrorCode.GeneralError, c.error)) : "undefined" == typeof c.userToken ?
                e(new PlayerIOError(PlayerIOErrorCode.GeneralError, "Missing userToken value in result, but no error message given.")) : PlayerIO.authenticate(b, g, { userToken: c.userToken }, d, a, e)
        }); else { var f = new _pio.channel; f.authenticate(b, g, _pio.convertToKVArray(c), _pio.convertToSegmentArray(d), "javascript", _pio.convertToKVArray({}), null, a, e, function (a) { f.token = a.token; return new _pio.client(f, b, a.gamefsredirectmap, a.userid) }) }
    }, quickConnect: null, gameFS: function (b) { return new _pio.gameFS(b) }
}; var JSON;
JSON || (JSON = {});
(function () {
    function b(a) { return 10 > a ? "0" + a : a } function g(c) { a.lastIndex = 0; return a.test(c) ? '"' + c.replace(a, function (a) { var c = h[a]; return "string" === typeof c ? c : "\\u" + ("0000" + a.charCodeAt(0).toString(16)).slice(-4) }) + '"' : '"' + c + '"' } function c(a, d) {
        var b, h, k, m, v = e, r, n = d[a]; n && "object" === typeof n && "function" === typeof n.toJSON && (n = n.toJSON(a)); "function" === typeof l && (n = l.call(d, a, n)); switch (typeof n) {
            case "string": return g(n); case "number": return isFinite(n) ? String(n) : "null"; case "boolean": case "null": return String(n); case "object": if (!n) return "null";
...
(function () {
    function b(c) { if (null != a) c(a); else if (e) c(null); else if (null == f) { f = [c]; var d = setInterval(function () { var a = g(); null != a && b(a) }, 50); setTimeout(function () { null == a && b(null) }, 3E4); var b = function (c) { a = c; e = null == c; clearInterval(d); for (var b = 0; b != f.length; b++)f[b](c) } } else f.push(c) } function g() {
        ...
        return a("embed") || a("object")
    } var c = {}, d = 0; __pio_flashfallback_callback__ = function () { var a = c[arguments[0]]; if (a) { for (var e = [], d = 1; d != arguments.length; d++)e[d - 1] = arguments[d]; a.apply(null, e) } }; _pio.flashWebRequest = function (a, e) {
        var f = this; this.response = null; this.onload = function () { }; this.onerror = function () { }; this.send = function (g) {
            b(function (b) {
                if (null == b) f.onerror("Browser does not support Cross-Origin (CORS) webrequest or Flash as a fallback method"); else {
                    var h = "cb" + d++; c[h] = function (a, e) {
                        delete c[h];
                        if (a) f.response = e, f.onload(); else f.onerror(e)
                    }; b.webrequest(h, a, e, g)
                }
            })
        }
...
(function () {
    ...
    b.leaderboardsCount = function (b, c, d, a, e) { this.call(437, { group: b, leaderboard: c }, d, a, e) }; b.joinCluster = function (b, c, d, a, e, f, h, l, k, m, t, q, p, u, v, r, n) { this.call(504, { clusteraccesskey: b, isdevelopmentserver: c, ports: d, machinename: a, version: e, machineid: f, os: h, cpu: l, cpucores: k, cpulogicalcores: m, cpuaddresswidth: t, cpumaxclockspeed: q, rammegabytes: p, ramspeed: u }, v, r, n) }; b.serverHeartbeat = function (b, c, d, a, e, f, h, l, k, m, t, q, p, u, v, r, n, x, w, y) {
        this.call(510, {
            serverid: b, appdomains: c, servertypes: d, machinecpu: a, processcpu: e,
            memoryusage: f, avaliablememory: h, freememory: l, runningrooms: k, usedresources: m, apirequests: t, apirequestserror: q, apirequestsfailed: p, apirequestsexecuting: u, apirequestsqueued: v, apirequeststime: r, serverunixtimeutc: n
        }, x, w, y)
    }; b.getGameAssemblyUrl = function (b, c, d, a, e, f) { this.call(513, { clusteraccesskey: b, gamecodeid: c, machineid: d }, a, e, f) }; b.devServerLogin = function (b, c, d, a, e) { this.call(524, { username: b, password: c }, d, a, e) }; b.webserviceOnlineTest = function (b, c, d) { this.call(533, {}, b, c, d) }; b.getServerInfo = function (b,
        c, d, a) { this.call(540, { machineid: b }, c, d, a) }; b.socialRefresh = function (b, c, d) { this.call(601, {}, b, c, d) }; b.socialLoadProfiles = function (b, c, d, a) { this.call(604, { userids: b }, c, d, a) }
})(); PlayerIOError = function (b, g, c) { this.code = b; this.message = g; this.stack = c; this.stack || (c = Error(), this.stack = c.stack || c.stacktrace || c.StackTrace); this.toString = function () { return "PlayerIOError[" + b + "]: " + g } }; PlayerIOError.prototype = Error();
PlayerIOErrorCode = {
    UnsupportedMethod: "UnsupportedMethod", GeneralError: "GeneralError", InternalError: "InternalError", AccessDenied: "AccessDenied", InvalidMessageFormat: "InvalidMessageFormat", MissingValue: "MissingValue", GameRequired: "GameRequired", ExternalError: "ExternalError", ArgumentOutOfRange: "ArgumentOutOfRange", GameDisabled: "GameDisabled", UnknownGame: "UnknownGame", UnknownConnection: "UnknownConnection", InvalidAuth: "InvalidAuth", NoServersAvailable: "NoServersAvailable", RoomDataTooLarge: "RoomDataTooLarge",
...
(function () {
    var b = {}; _pio.gameFS = function (g, c) {
        if ("string" == typeof c && 0 < c.length) { var d = (c || "").split("|"); if (1 <= d.length) for (var a = b[g.toLowerCase()] = {}, e = 0; e != d.length; e++) { var f = d[e]; "alltoredirect" == f || "cdnmap" == f ? a.baseUrl = d[e + 1] : "alltoredirectsecure" == f || "cdnmapsecure" == f ? a.secureBaseUrl = d[e + 1] : a["." + f] = d[e + 1] } } this.getUrl = function (a, c) {
            if ("/" == !a[0]) throw _pio.error("The path given to getUrl must start with a slash, like: '/myfile.swf' or '/folder/file.jpg'"); var e = b[g]; return e ? (c ? e.secureBaseUrl :
                e.baseUrl) + (e["." + a] || a) : (c ? "https" : "http") + "://r.playerio.com/r/" + g + a
        }
    }
})();
(function () {
    _pio.gameRequests = function (b) {
        function g(a) { if (null == a || 0 == a.length) return []; for (var c = [], b = 0; b != a.length; b++) { var d = a[b]; c.push(new _pio.gameRequest(d.id, d.type, d.senderuserid, d.created, d.data)) } return c } var c = []; this.waitingRequests = "[ERROR: You tried to access gameRequests.waitingRequests before loading waiting requests. You have to call the refresh method first.]"; var d = this; this.send = function (a, c, d, h, l) { b.gameRequestsSend(a, _pio.convertToKVArray(c), d, h, l, function (a) { }) }; this.refresh =
            function (a, e) { b.gameRequestsRefresh(c, a, e, function (a) { d._playCodes = a.newplaycodes; d.waitingRequests = g(a.requests) }) }; this["delete"] = function (a, c, f) {
                if ("object" == typeof a || a.length) {
                    for (var e = [], l = 0; l != a.length; l++) { var k = a[l].id; if (k) e.push(k); else { a = _pio.error("No GameRequest id found on item#" + l + ". You have to use requests from the gameRequests.waitingRequests array. For instance: client.gameRequests.delete(client.gameRequests.waitingRequests, ...)"); _pio.handleError(a, f, a.code, a.message); return } } b.gameRequestsDelete(e,
                        c, f, function (a) { d.waitingRequests = g(a.requests) })
                } else a = _pio.error("The first argument to delete should be an array: client.gameRequests.delete([requests], ...)"), _pio.handleError(a, f, a.code, a.message)
            }
    }; _pio.gameRequest = function (b, g, c, d, a) { this.id = b; this.type = g; this.senderUserId = c; this.created = new Date(d); this.data = _pio.convertFromKVArray(a) }
})(); (function () { _pio.errorLog = function (b) { this.writeError = function (g, c, d, a) { b.writeError("Javascript", g, c, d, _pio.convertToKVArray(a)) } } })();
...
(function () {
    _pio.payVault = function (b) {
        function g(a) { if (null != a && (c = a.version, d.coins = a.coins || 0, d.items = [], a.items && a.items.length)) for (var b = 0; b != a.items.length; b++) { var f = a.items[b], h = d.items[b] = new _pio.vaultItem(f.id, f.itemkey, (new Date).setTime(f.purchasedate)); _pio.bigDBDeserialize(f.properties, h, !0) } } var c = null; this.coins = "[ERROR: you tried to access payVault.coins before the vault was loaded. You have to refresh the vault before the .coins property is set to the right value]"; this.items = "[ERROR: you tried to access payVault.items before the vault was loaded. You have to refresh the vault before the .items property is set to the right value]";
        this.has = function (a) { if (null == c) throw new PlayerIOError(PlayerIOErrorCode.VaultNotLoaded, "Cannot access items before vault has been loaded. Please refresh the vault first"); for (var b = 0; b != this.items.length; b++)if (this.items[b].itemKey == a) return !0; return !1 }; this.first = function (a) {
            if (null == c) throw new PlayerIOError(PlayerIOErrorCode.VaultNotLoaded, "Cannot access items before vault has been loaded. Please refresh the vault first"); for (var b = 0; b != this.items.length; b++)if (this.items[b].itemKey == a) return this.items[b];
            return null
        }; this.count = function (a) { if (null == c) throw new PlayerIOError(PlayerIOErrorCode.VaultNotLoaded, "Cannot access items before vault has been loaded. Please refresh the vault first"); for (var b = 0, d = 0; d != this.items.length; d++)this.items[d].itemKey == a && b++; return b }; this.refresh = function (a, d) { b.payVaultRefresh(c, null, a, d, function (a) { g(a.vaultcontents) }) }; this.readHistory = function (a, c, d, h) {
            b.payVaultReadHistory(a, c, null, d, h, function (a) {
                for (var c = [], b = 0; b != a.entries.length; b++) {
                    var d = a.entries[b];
                    c.push(new _pio.payVaultHistoryEntry(d.type, d.amount, d.timestamp, d.itemkeys || [], d.reason, d.providertransactionid, d.providerprice))
                } return c
            })
        }; this.credit = function (a, c, d, h) { b.payVaultCredit(a, c, null, d, h, function (a) { g(a.vaultcontents) }) }; this.debit = function (a, c, d, h) { b.payVaultDebit(a, c, null, d, h, function (a) { g(a.vaultcontents) }) }; this.consume = function (a, c, d) {
            if ("object" == typeof a || a.length) {
                for (var e = [], f = 0; f != a.length; f++) {
                    var k = a[f].id; if (k) e.push(k); else {
                        a = _pio.error("No PayVault item id found on item#" +
                            f + ". You have to use items from the payVault.items array. For instance: client.payVault.consume([client.payVault.first('sportscar')], ...)"); _pio.handleError(a, d, a.code, a.message); return
                    }
                } b.payVaultConsume(e, null, c, d, function (a) { g(a.vaultcontents) })
            } else a = _pio.error("The first argument to consume should be an array: client.payVault.consume([item], ...)"), _pio.handleError(a, d, a.code, a.message)
        }; this.buy = function (a, c, d, h) { b.payVaultBuy(_pio.convertBuyItems(a), c, null, d, h, function (a) { g(a.vaultcontents) }) };
        this.give = function (a, c, d) { b.payVaultGive(_pio.convertBuyItems(a), null, c, d, function (a) { g(a.vaultcontents) }) }; this.getBuyCoinsInfo = function (a, c, d, h) { b.payVaultPaymentInfo(a, _pio.convertToKVArray(c), null, d, h, function (a) { return _pio.convertFromKVArray(a.providerarguments) }) }; this.getBuyDirectInfo = function (a, c, d, h, g) { b.payVaultPaymentInfo(a, _pio.convertToKVArray(c), _pio.convertBuyItems(d), h, g, function (a) { return _pio.convertFromKVArray(a.providerarguments) }) }; var d = this
    }; _pio.convertBuyItems = function (b) {
        if (null ==
            b) return []; for (var g = [], c = 0; c != b.length; c++) { var d = b[c].itemkey; if (!d) throw _pio.error("You have to specify an itemkey for the payvault item. Example:  {itemkey:'car'}"); g.push({ itemkey: d, payload: _pio.compareForChanges({ itemkey: d }, b[c], !0, !0) }) } return g
    }; _pio.vaultItem = function (b, g, c) { this.id = b; this.itemKey = g; this.purchaseDate = c }; _pio.payVaultHistoryEntry = function (b, g, c, d, a, e, f) {
        this.type = b; this.amount = g; this.timestamp = (new Date).setTime(c); this.itemKeys = d; this.reason = a; this.providerTransactionId =
            e; this.providerPrice = f
    }
})();
(function () {
    _pio.bigDB = function (b) {
        function g() {
            for (var c = 0; c < a.length; c++) {
                var b = a[c], d = !0, g; for (g in b.objects) if (b.objects[g]._internal_("get-is-saving")) { d = !1; break } if (d) {
                    for (g in b.objects) for (d = c + 1; d < a.length; d++) { futureSave = a[d]; for (var k = 0; k < futureSave.objects.length; k++)futureSave.objects[k] == b.objects[g] && futureSave.fullOverwrite == b.fullOverwrite && futureSave.useOptimisticLock == b.useOptimisticLock && (b.changesets[g] = futureSave.changesets[k], b.futureSaves.push(futureSave)) } a.splice(c, 1); c--;
                    b.execute()
                }
            }
        } function c(a, c) {
            null == a ? a = [] : a instanceof Array || (a = [a]); null != c && (a = a.concat([c])); for (var b = [], d = 0; d != a.length; d++) {
                var e = a[d]; switch (typeof e) {
                    case "boolean": b.push({ valuetype: _pio.ValueType.Bool, bool: e }); break; case "string": b.push({ valuetype: _pio.ValueType.String, string: e }); break; case "number": 0 != e % 1 ? b.push({ valuetype: _pio.ValueType.Double, "double": e }) : -2147483648 < e && 2147483647 > e ? b.push({ valuetype: _pio.ValueType.Int, "int": e }) : 0 < e && 4294967295 > e ? b.push({
                        valuetype: _pio.ValueType.UInt,
                        uint: e
                    }) : b.push({ valuetype: _pio.ValueType.Long, "long": e }); break; case "object": if (e.getTime && e.getMilliseconds) b.push({ valuetype: _pio.ValueType.DateTime, datetime: e.getTime() }); else throw Error("Don't know how to serialize type '" + typeof e + "' for BigDB"); break; default: throw Error("Don't know how to serialize type '" + typeof e + "' for BigDB");
                }
            } return b
        } var d = this, a = []; this.createObject = function (a, c, h, g, k) {
            var e = _pio.compareForChanges({}, h || {}, !0, !0); b.createObjects([{ key: c, table: a, properties: e }], !1, g,
                k, function (c) { if (1 == c.objects.length) return new _pio.databaseobject(d, a, c.objects[0].key, c.objects[0].version, !1, e); throw new PlayerIOError(PlayerIOErrorCode.GeneralError, "Error creating object"); })
        }; this.loadMyPlayerObject = function (a, c) { b.loadMyPlayerObject(a, c, function (a) { return new _pio.databaseobject(d, "PlayerObjects", a.playerobject.key, a.playerobject.version, !0, a.playerobject.properties) }) }; this.load = function (a, c, h, g) {
            b.loadObjects([{ table: a, keys: [c] }], h, g, function (c) {
                if (1 == c.objects.length) return null ==
                    c.objects[0] ? null : new _pio.databaseobject(d, a, c.objects[0].key, c.objects[0].version, !1, c.objects[0].properties); throw new PlayerIOError(PlayerIOErrorCode.GeneralError, "Error loading object");
            })
        }; this.loadKeys = function (a, c, h, g) { b.loadObjects([{ table: a, keys: c }], h, g, function (c) { for (var b = [], e = 0; e != c.objects.length; e++) { var f = c.objects[e]; b[e] = null == f ? null : new _pio.databaseobject(d, a, f.key, f.version, !1, f.properties) } return b }) }; this.loadOrCreate = function (a, c, h, g) {
            b.createObjects([{ key: c, table: a, properties: [] }],
                !0, h, g, function (c) { if (1 == c.objects.length) return new _pio.databaseobject(d, a, c.objects[0].key, c.objects[0].version, !1, c.objects[0].properties); throw new PlayerIOError(PlayerIOErrorCode.GeneralError, "Error creating object"); })
        }; this.deleteKeys = function (a, c, d, g) { b.deleteObjects([{ table: a, keys: c }], d, g, function (a) { return null }) }; this.loadKeysOrCreate = function (a, c, h, g) {
            for (var e = [], f = 0; f != c.length; f++)e.push({ key: c[f], table: a, properties: [] }); b.createObjects(e, !0, h, g, function (c) {
                for (var b = [], e = 0; e != c.objects.length; e++) {
                    var f =
                        c.objects[e]; b[e] = new _pio.databaseobject(d, a, f.key, f.version, !1, f.properties)
                } return b
            })
        }; this.loadSingle = function (a, f, h, g, k) { b.loadMatchingObjects(a, f, c(h), 1, g, k, function (c) { return 0 == c.objects.length ? null : new _pio.databaseobject(d, a, c.objects[0].key, c.objects[0].version, !1, c.objects[0].properties) }) }; this.loadRange = function (a, f, h, g, k, m, t, q) {
            b.loadIndexRange(a, f, c(h, g), c(h, k), m, t, q, function (c) {
                for (var b = [], e = 0; e != c.objects.length; e++) {
                    var f = c.objects[e]; b[e] = null == f ? null : new _pio.databaseobject(d,
                        a, f.key, f.version, !1, f.properties)
                } return b
            })
        }; this.deleteRange = function (a, d, h, g, k, m, t) { b.deleteIndexRange(a, d, c(h, g), c(h, k), m, t, function () { }) }; this.saveChanges = function (c, d, h, l, k, m) {
            var e = 1 == m; m = []; for (var f in h) {
                var p = h[f]; if (!(p.existsInDatabase && p.key && p.table && p._internal_ && p.save)) { c = _pio.error("You can only save database objects that exist in the database"); _pio.handleError(c, k, c.code, c.message); return } var u = _pio.compareForChanges(d ? {} : p._internal_("get-dbCurrent"), p, !0, !0); (d || 0 < u.length) &&
                    m.push({ key: p._internal_("get-key"), table: p._internal_("get-table"), fulloverwrite: d, onlyifversion: c ? p._internal_("get-version") : null, changes: u })
            } a.push({
                objects: h, changesets: m, fullOverwrite: d, useOptimisticLock: c, futureSaves: [], setIsSavingOnAll: function (a) { for (var c = 0; c != this.objects.length; c++)this.objects[c]._internal_("set-is-saving", a) }, done: function () { this.setIsSavingOnAll(!1); g() }, execute: function () {
                    var a = this; a.setIsSavingOnAll(!0); 0 < a.changesets.length ? b.saveObjectChanges(_pio.LockType.LockAll,
    ...
    }; _pio.databaseobject = function (b, g, c, d, a, e) {
        var f =
        ...
        function (b, g, c) {
            for (var d in b) {
                var a = b[d], e = c ? a.name : a.index || 0; if (a = a.value) switch (a.valuetype || 0) {
                    case _pio.ValueType.String: g[e] = a.string || ""; break; case _pio.ValueType.Int: g[e] = a["int"] || 0; break; case _pio.ValueType.UInt: g[e] = a.uint || 0; break; case _pio.ValueType.Long: g[e] = a["long"] || 0; break; case _pio.ValueType.Bool: g[e] = a.bool || 0; break; case _pio.ValueType.Float: g[e] = a["float"] || 0; break; case _pio.ValueType.Double: g[e] = a["double"] || 0; break; case _pio.ValueType.ByteArray: g[e] = a.bytearray; g[e].bytearray =
                        !0; break; case _pio.ValueType.DateTime: g[e] = new Date(a.datetime || 0); break; case _pio.ValueType.Array: var f = g[e] instanceof Array ? g[e] : []; _pio.bigDBDeserialize(a.arrayproperties, f, !1); g[e] = f; break; case _pio.ValueType.Obj: f = "object" == typeof g[e] ? g[e] : {}, _pio.bigDBDeserialize(a.objectproperties, f, !0), g[e] = f
                } else delete g[e]
            }
        }
})();
(function () {
    _pio.multiplayer = function (c) {
        var b = this; this.developmentServer = null; this.useSecureConnections = !1; this.createRoom = function (a, d, f, h, g, k) { c.createRoom(a, d, f, _pio.convertToKVArray(h), null != b.developmentServer, g, k, function (a) { return a.roomid }) }; this.joinRoom = function (a, d, f, h) {
            clearTimeout(setTimeout(function () { f(new _pio.connection) }, 1E4)); var e = Error(); c.joinRoom(a, _pio.convertToKVArray(d), null != b.developmentServer, b.useSecureConnections, function () { }, h, function (a) {
                return new _pio.connection(e,
                    b.developmentServer, b.useSecureConnections, a.endpoints, a.joinkey, d || {}, f, h)
            })
        }; this.createJoinRoom = function (a, d, f, h, g, k, m) { clearTimeout(setTimeout(function () { k(new _pio.connection) }, 1E4)); var e = Error(); c.createJoinRoom(a, d, f, _pio.convertToKVArray(h), _pio.convertToKVArray(g), null != b.developmentServer, b.useSecureConnections, function () { }, m, function (a) { return new _pio.connection(e, b.developmentServer, b.useSecureConnections, a.endpoints, a.joinkey, g || {}, k, m) }) }; this.listRooms = function (a, d, f, h, g, k) {
            c.listRooms(a,
                _pio.convertToKVArray(d), f, h, null != b.developmentServer, g, k, function (a) { var c = []; if (a.rooms && 0 < a.rooms.length) for (var b = 0; b != a.rooms.length; b++) { var d = a.rooms[b]; c.push(new _pio.roomInfo(d.id, d.roomtype, d.onlineusers, _pio.convertFromKVArray(d.roomdata))) } return c })
        }
    }; _pio.websocketConnection = function (c, b, a, e, f, h, g) {
        var d = this, m = !1, l = new _pio.messageSerializer, q = !1, p = null; b = (b ? "wss://" : "ws://") + a + "/"; try { p = "undefined" != typeof MozWebSocket ? new MozWebSocket(b) : new WebSocket(b) } catch (v) { f(!1, "" + v); return } var u =
        ...
        this.disconnect = function () { if (q) { q = !1; h(); try { p.close() } catch (v) { _pio.debugLog(v) } } }; this.sendMessage = function (a) { a = l.serializeMessage(a); if (c) { for (var b = new Uint8Array(a.length), d = 0; d < a.length; d++)b[d] = a[d]; p.send(b.buffer) } else a = _pio.base64encode(a), p.send(a) }
    }; _pio.connection = function (c, b, a, e, f, h, g, k) {
        function d(d) {
            function m() {
                if (0 < n.length) {
                    var b = n[0]; n.splice(0, 1); var e = d(a, b, 4E3, function (a, c) {
                        if (a) {
                            r = e; l.connected = !0; var d = l.createMessage("join"); d.addString(f); if (null != h) for (var g in h) d.addString(g),
                                d.addString("" + h[g]); l.sendMessage(d)
                        } else _pio.debugLog("Unable to connect to endpoint: " + b + '. reason: "' + c + (0 < n.length ? '". Trying next endpoint.' : '". No more endpoints to try.')), m()
                    }, function (a) { l.connected && (l.connected = !1, setTimeout(function () { for (var a = 0; a != p.length; a++)_pio.runCallback(p[a].callback, l, p[a].stackSource) }, 100)) }, function (a) {
                        q ? "playerio.joinresult" == a.type ? (q = !1, a.getBoolean(0) ? _pio.runCallback(g, l, null) : _pio.handleError(c, k, a.getInt(1), a.getString(2))) : _pio.handleError(c, k, PlayerIOErrorCode.GeneralError,
                            "The expected inital messagetype is: playerio.joinresult, received: " + joinResult.getType()) : (t(a.type, a), t("*", a))
                    })
                } else _pio.handleError(c, k, PlayerIOErrorCode.GeneralError, "Could not establish a socket connection to any of the given endpoints for the room")
            } function t(a, c) { var b = u[a]; if (b) for (var d = 0; d < b.length; d++)_pio.runCallback(b[d].callback, c, b[d].stackSource) } var n = []; if (b) n.push(b); else for (var w = 0; w != e.length; w++)n.push(e[w].address + ":" + e[w].port); m()
        } var l = this, q = !0, p = [], u = {}, v = [], r = null,
            n = /(WebKit|Firefox|Trident)\/([0-9]+)/gi.exec(navigator.userAgent), x = n && 3 <= n.length ? n[1] : null, n = n && 3 <= n.length ? parseInt(n[2]) : null; window.FileReader && "WebKit" == x && 535 <= n || "Firefox" == x && 11 <= n || "Trident" == x && 6 <= n ? d(function (a, c, b, d, e, f) { return new _pio.websocketConnection(!0, a, c, b, d, e, f) }) : _pio.isFlashFallbackEnabled(function (a) { a ? d(function (a, c, b, d, e, f) { return new _pio.flashSocketConnection(c, b, d, e, f) }) : d(function (a, c, b, d, e, f) { return new _pio.websocketConnection(!1, a, c, b, d, e, f) }) }); this.connected =
                !1; this.addDisconnectCallback = function (a) { p.push({ callback: a, stackSourc: Error() }) }; this.addMessageCallback = function (a, c) { null == a && (a = "*"); var b = u[a]; b || (u[a] = b = []); b.push({ callback: c, stackSource: Error() }) }; this.removeDisconnectCallback = function (a) { for (var c = 0; c < p.length; c++)p[c].callback == a && (p.splice(c, 1), c--) }; this.removeMessageCallback = function (a) { for (var c in u) for (var b = u[c], d = 0; d < b.length; d++)b[d].callback == a && (b.splice(d, 1), d--) }; this.createMessage = function (a) {
                    for (var c = new _pio.message(a),
                        b = 1; b < arguments.length; b++)c.add(arguments[b]); return c
                }; this.send = function (a) { var c = this.createMessage.apply(this, arguments); this.sendMessage(c) }; this.sendMessage = function (a) { l.connected ? r.sendMessage(a) : v.push(a) }; this.disconnect = function () { l.connected && r.disconnect() }
    }; _pio.message = function (c) {
        function b(a, c, b, d) { if (a) k.push(c), g.push(b), h.length = k.length; else throw _pio.error("The given value (" + c + ") is not " + d); } function a(a, c) {
            if (a > k.length) throw _pio.error("this message (" + h.type + ") only has " +
                k.length + " entries"); if (g[a] == c) return k[a]; throw _pio.error("Value at index:" + a + " is a " + e(g[a]) + " and not a " + e(c) + " as requested. The value is: " + k[a]);
            ...
            function (c) { return a(c, 5) }; this.getByteArray = function (c) { return a(c, 7) }; this.getString = function (c) { return a(c, 6) }; this.toString = function () { for (var a = "msg.Type = " + this.type + "", c = 0; c != this.length; c++)a += ", msg[" + c + "] = " + k[c] + " (" + e(g[c]) + ")"; return a }; this._internal_ = function (a, c) { switch (a) { case "get-objects": return k; case "get-types": return g } }
    }; _pio.roomInfo = function (c, b, a, e) { this.id = c; this.roomType = b; this.onlineUsers = a; this.roomData = e }; _pio.byteWriter = function () {
        this.bytes = []; this.writeByte = function (c) {
            if (0 <=
                c && 255 >= c) this.bytes.push(c); else throw Error("This is not a byte value: " + c);
        }; this.writeBytes = function (c) { for (var b = 0; b != c.length; b++)this.writeByte(c[b]) }; this.writeTagWithLength = function (c, b, a) { 63 < c || 0 > c ? this.writeBottomPatternAndBytes(a, _pio.binaryserializer.bytesFromInt(c)) : this.writeByte(b | c) }; this.writeBottomPatternAndBytes = function (c, b) { var a = 0; 0 != b[0] ? a = 3 : 0 != b[1] ? a = 2 : 0 != b[2] && (a = 1); this.writeByte(c | a); for (a = b.length - a - 1; a != b.length; a++)this.writeByte(b[a]) }; this.writeLongPattern = function (c,
            b, a) { for (var d = 0, f = 0; 7 != f; f++)if (0 != a[f]) { d = 7 - f; break } 3 < d ? this.writeByte(b | d - 4) : this.writeByte(c | d); for (f = a.length - d - 1; f != a.length; f++)this.writeByte(a[f]) }
    }; _pio.messageSerializer = function () {
        this.serializeMessage = function (c) {
            var b = new _pio.byteWriter; b.writeTagWithLength(c.length, 128, 4); var a = _pio.binaryserializer.bytesFromString(c.type); b.writeTagWithLength(a.length, 192, 12); b.writeBytes(a); for (var e = 0; e != c.length; e++)switch (a = c._internal_("get-objects")[e], c._internal_("get-types")[e]) {
                case 6: a =
                    ...
                    break; case 5: b.writeByte(2); a = _pio.binaryserializer.bytesFromFloat(a); b.writeBytes(a); break; case 8: b.writeByte(a ? 1 : 0)
            }return b.bytes
        }; this.deserializeMessage = function (c, b, a) {
            var d = b; b += a; a = null; for (var f = 0; d < b;) {
                var h = 0, g = 0, k = c[d]; d++; var m = k & 192; 0 == m && (m = k & 60, 0 == m && (m = k)); switch (m) {
                    case 12: case 16: h = (k & 3) + 1; if (d + h > b) throw Error("Unexpected: Unfinished message"); k = h; h = _pio.binaryserializer.intFromBytes(c, d, h); d += k; break; case 192: h = k & 63; break; case 128: g = k & 63; break; case 64: h = k & 63; break; case 4: case 8: case 48: case 56: h =
                        (k & 3) + 1; break; case 52: case 60: h = (k & 3) + 5; break; case 3: h = 8; break; case 2: h = 4
                }if (d + h > b) throw Error("Unexpected: Unfinished message"); switch (m) {
                    case 12: case 192: null == a ? (a = new _pio.message(_pio.binaryserializer.stringFromBytes(c, d, h)), f++) : a.addString(_pio.binaryserializer.stringFromBytes(c, d, h)); break; case 4: g = _pio.binaryserializer.intFromBytes(c, d, h); case 128: 0 == f ? f = g : a.addInt(g); break; case 16: case 64: a.addByteArray(c.slice(d, d + h)); break; case 8: a.addUInt(_pio.binaryserializer.uintFromBytes(c, d, h)); break;
                    case 48: case 52: a.addLong(_pio.binaryserializer.longFromBytes(c, d, h)); break; case 56: case 60: a.addULong(_pio.binaryserializer.ulongFromBytes(c, d, h)); break; case 3: a.addDouble(_pio.binaryserializer.doubleFromBytes(c, d, h)); break; case 2: a.addFloat(_pio.binaryserializer.floatFromBytes(c, d, h)); break; case 1: a.addBoolean(!0); break; case 0: a.addBoolean(!1)
                }d += h; if (null != a && 0 == --f) return a
            } throw Error("Unexpected: Misaligned message");
        }
    }; _pio.binaryserializer = {
        pow2: function (c) {
            return 0 <= c && 31 > c ? 1 << c : this.pow2[c] ||
                (this.pow2[c] = Math.pow(2, c))
        }, _intEncode: function (c, b) { var a; if (4 == b) a = [c >>> 24 & 255, c >>> 16 & 255, c >>> 8 & 255, c & 255]; else { if (0 <= c) { a = Math.floor(c / this.pow2(32)); var d = c - a * this.pow2(32) } else a = Math.floor(c / this.pow2(32)), d = c - a * this.pow2(32), a += this.pow2(32); a = [a >>> 24 & 255, a >>> 16 & 255, a >>> 8 & 255, a & 255, d >>> 24 & 255, d >>> 16 & 255, d >>> 8 & 255, d & 255] } return a }, _floatEncode: function (c, b, a) {
            var d = 0 > c ? 1 : 0, f, h = ~(-1 << a - 1), g = 1 - h; 0 > c && (c = -c); 0 === c ? c = f = 0 : isNaN(c) ? (f = 2 * h + 1, c = 1) : Infinity === c ? (f = 2 * h + 1, c = 0) : (f = Math.floor(Math.log(c) /
                Math.LN2), f >= g && f <= h ? (c = Math.floor((c * this.pow2(-f) - 1) * this.pow2(b)), f += h) : (c = Math.floor(c / this.pow2(g - b)), f = 0)); for (h = []; 8 <= b;)h.push(c % 256), c = Math.floor(c / 256), b -= 8; f = f << b | c; for (a += b; 8 <= a;)h.push(f & 255), f >>>= 8, a -= 8; h.push(d << a | f); h.reverse(); return h
        }, bytesFromString: function (c) { for (var b = [], a = 0; a < c.length; a++)if (127 >= c.charCodeAt(a)) b.push(c.charCodeAt(a)); else for (var e = encodeURIComponent(c.charAt(a)).substr(1).split("%"), f = 0; f < e.length; f++)b.push(parseInt(e[f], 16)); return b }, bytesFromInt: function (c) {
            return this._intEncode(c,
                4)
        }, bytesFromUInt: function (c) { return this._intEncode(c, 4) }, bytesFromLong: function (c) { return this._intEncode(c, 8) }, bytesFromULong: function (c) { return this._intEncode(c, 8) }, bytesFromFloat: function (c) { return this._floatEncode(c, 23, 8) }, bytesFromDouble: function (c) { return this._floatEncode(c, 52, 11) }, _intDecode: function (c, b, a, e, f) { var d = b + a - 1; b = f && a == e && c[b] & 128; e = 0; f = 1; for (var g = 0; g < a; g++) { var k = c[d - g]; b && (k = (k ^ 255) + f, f = k >> 8, k &= 255); e += k * this.pow2(8 * g) } return b ? -e : e }, _float32Decode: function (c, b) {
            var a = c.slice(b,
        ...
        }, _float64Decode: function (c, b) {
            var a = c.slice(b, b + 8).reverse(), d = 1 - 2 * (a[7] >> 7), f = ((a[7] << 1 & 255) << 3 | a[6] >> 4) - 1023, a = (a[6] & 15) * this.pow2(48) + a[5] * this.pow2(40) + a[4] * this.pow2(32) + a[3] * this.pow2(24) + a[2] * this.pow2(16) + a[1] * this.pow2(8) + a[0]; return 1024 === f ? 0 !== a ? NaN : Infinity * d : -1023 === f ? d * a * this.pow2(-1074) : d * (1 + a *
            ...
            a) { return 4 == a ? this._float32Decode(b, d) : NaN }, doubleFromBytes: function (b, d, a) { return 8 == a ? this._float64Decode(b, d) : NaN }
    }; for (var b = [], g = 0; 65 != g; g++)b["ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charCodeAt(g)] = g; _pio.base64encode = function (b) {
        for (var c = [], a = 0; a < b.length; a++) {
            var e = b[a], f = ++a <= b.length ? b[a] : NaN, g = ++a <= b.length ? b[a] : NaN, l = e >> 2, e = (e & 3) << 4 | f >> 4, k = (f & 15) << 2 | g >> 6, m = g & 63; isNaN(f) ? k = m = 64 : isNaN(g) && (m = 64); c.push("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(l));
            c.push("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(e)); c.push("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(k)); c.push("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(m))
        } return c.join("")
    }; _pio.base64decode = function (c) {
        for (var d = [], a = 0; a < c.length; a++) {
            var e = b[c.charCodeAt(a)], f = ++a < c.length ? b[c.charCodeAt(a)] : 64, g = ++a < c.length ? b[c.charCodeAt(a)] : 64, l = ++a < c.length ? b[c.charCodeAt(a)] : 64, k = (f & 15) << 4 | g >> 2, m = (g & 3) <<
                6 | l; d.push(e << 2 | f >> 4); 64 != g && (d.push(k), 64 != l && d.push(m))
        } return d
    }
})();
(function () {
    _pio.achievements = function (b) {
        function g(a, b) { var c = new _pio.achievement(a.identifier, a.title, a.description, a.imageurl, a.progress, a.progressgoal, a.lastupdated); if ("string" !== typeof d.myAchievements) for (var e = 0; e < d.myAchievements.length; e++)d.myAchievements[e].id == c.id && (d.myAchievements[e] = c, d.currentVersion = null); if (b) for (e = 0; e < d.onCompleteHandlers.length; e++)(0, d.onCompleteHandlers[e])(c); return c } var c = null; this.myAchievements = "[ERROR: You tried to access achievements.myAchievements before loading them. You have to call the refresh method first.]";
        this.onCompleteHandlers = []; var d = this; this.addOnComplete = function (a) { if ("function" === typeof a && 1 == a.length) d.onCompleteHandlers.push(a); else throw new PlayerIOError(PlayerIOErrorCode.InvalidArgument, "Expects argument to be a function that takes an achievement as an argument."); }; this.get = function (a) { if ("string" === typeof d.myAchievements) return null; for (var b = 0; b < d.myAchievements.length; b++)if (d.myAchievements[b].id == a) return d.myAchievements[b]; return null }; this.refresh = function (a, e) {
            b.achievementsRefresh(c,
                a, e, function (a) { if (c != a.version) if (c = a.version, null == a.achievements || 0 == a.achievements.length) d.myAchievements = []; else { for (var b = [], e = 0; e < a.achievements.length; e++) { var f = a.achievements[e]; b.push(new _pio.achievement(f.identifier, f.title, f.description, f.imageurl, f.progress, f.progressgoal, f.lastupdated)) } d.myAchievements = b } })
        }; this.load = function (a, c, d) {
            "object" == typeof a || requests.length ? b.achievementsLoad(a, c, d, function (a) {
                if (null == a || 0 == a.length) return {}; for (var b = {}, c = 0; c < a.userachievements.length; c++) {
                    for (var d =
                        a.userachievements[c], e = [], f = 0; f < d.achievements.length; f++) { var g = d.achievements[f]; e.push(new _pio.achievement(g.identifier, g.title, g.description, g.imageurl, g.progress, g.progressgoal, g.lastupdated)) } b[d.userid] = e
                } return b
            }) : (a = _pio.error("The first argument to load should be an array: client.achievements.load(['user1', 'user2', ...], ...)"), _pio.handleError(a, d, a.code, a.message))
        }; this.progressSet = function (a, c, d, h) { b.achievementsProgressSet(a, c, d, h, function (a) { return g(a.achievement, a.completednow) }) };
    ...
    }; _pio.achievement = function (b, g, c, d, a, e, f) {
        this.id = b; this.title = g; this.description = c; this.imageUrl = d; this.progress = "undefined" ===
...
(function () {
    _pio.leaderboards = function (b, g) {
        this.set = function (c, d, a, e, f) { b.leaderboardsSet(c, d, a, e, f, function (a) { return new _pio.leaderboardEntry(a.leaderboardentry.userid, a.leaderboardentry.rank, a.leaderboardentry.score) }) }; this.count = function (c, d, a, e) { b.leaderboardsCount(c, d, a, e, function (a) { return a.count }) }; this.getTop = function (c, d, a, e, f, g, l) {
            b.leaderboardsGet(c, d, a, e, null, f, g, l, function (a) {
                if (null == a || null == a.leaderboardentry || 0 == a.leaderboardentry.length) return []; for (var b = [], c = 0; c < a.leaderboardentry.length; c++)b.push(new _pio.leaderboardEntry(a.leaderboardentry[c].userid,
                    a.leaderboardentry[c].rank, a.leaderboardentry[c].score)); return b
            })
        }; this.getNeighbourhood = function (c, d, a, e, f, h, l) { b.leaderboardsGet(c, d, a, e, g, f, h, l, function (a) { if (null == a || null == a.leaderboardentry || 0 == a.leaderboardentry.length) return []; for (var b = [], c = 0; c < a.leaderboardentry.length; c++)b.push(new _pio.leaderboardEntry(a.leaderboardentry[c].userid, a.leaderboardentry[c].rank, a.leaderboardentry[c].score)); return b }) }
    }; _pio.leaderboardEntry = function (b, g, c) { this.userId = b; this.rank = g; this.score = c }
})();
(function () {
    _pio.oneScore = function (b) {
        this.percentile = "[ERROR: You tried to access oneScore.percentile before loading the OneScore. You have to call the refresh method first.]"; this.score = "[ERROR: You tried to access oneScore.score before loading the OneScore. You have to call the refresh method first.]"; this.topRank = "[ERROR: You tried to access oneScore.topRank before loading the OneScore. You have to call the refresh method first.]"; var g = this; this.refresh = function (c, d) {
            ...
            b.oneScoreAdd(c, d, a, function (a) {
                ...
                g.percentile = a.percentile; g.score = a.score; g.topRank = a.toprank; return a
            })
        }; this.load = function (c, d, a) {
            if ("object" == typeof c || requests.length) b.oneScoreLoad(c, d, a, function (a) { if (null == a || null == a.onescores || 0 == a.onescores.length) return []; for (var b = [], d = 0, e = 0; e < c.length; e++) { var g = a.onescores[d]; g && c[e] == g.userid ? (b.push(new _pio.oneScoreValue(g.percentile, g.score, g.toprank)), d++) : b.push(null) } return b }); else d = _pio.error("The first argument to load should be an array: client.oneScore.load(['user1', 'user2', ...], ...)"),
                _pio.handleError(d, a, d.code, d.message)
        }
    }; _pio.oneScoreValue = function (b, g, c) { this.percentile = "undefined" === typeof b ? 0 : b; this.score = "undefined" === typeof g ? 0 : g; this.topRank = "undefined" === typeof c ? 0 : c }
})();
(function () {
    _pio.notifications = function (b) {
        function g(b) { if (b.version != a) { var c = []; if (b.endpoints) for (var e = 0; e != b.endpoints.length; e++) { var g = b.endpoints[e]; c[e] = new _pio.notificationEndpoint(g.type, g.identifier, _pio.convertFromKVArray(g.configuration), g.enabled ? !0 : !1) } a = b.version; d.myEndpoints = c } } function c(a) { var b = []; if (a && 0 < a.length) for (var c = 0; c != a.length; c++) { var d = a[c]; d.type && d.identifier && b.push({ type: d.type, identifier: d.identifier }) } return b } this.myEndpoints = "[ERROR: You tried to access notifications.myEndpoints before calling refresh.]";
        var d = this, a = ""; this.refresh = function (c, d) { b.notificationsRefresh(a, c, d, g) }; this.registerEndpoint = function (c, f, h, l, k, m) { var e; a: { if ("" != a) for (e = 0; e != d.myEndpoints.length; e++) { var q = d.myEndpoints[e]; if (q.type == c && q.identifier == f) { e = q; break a } } e = null } (q = null == e || e.enabled != l) || (q = JSON.stringify(e.configuration) != JSON.stringify(h)); q ? b.notificationsRegisterEndpoints(a, [{ type: c, identifier: f, configuration: _pio.convertToKVArray(h), enabled: l }], k, m, g) : k && k() }; this.toggleEndpoints = function (d, f, h, l) {
            d = c(d);
            0 < d.length ? b.notificationsToggleEndpoints(a, d, f ? !0 : !1, h, l, g) : h && h()
        }; this.deleteEndpoints = function (d, f, h) { d = c(d); 0 < d.length ? b.notificationsDeleteEndpoints(a, d, f, h, g) : f && f() }; this.send = function (a, c, d) {
            for (var e = [], f = 0; f != a.length; f++) { var g = a[f], h = { recipient: g.recipientUserId, endpointtype: g.endpointType, data: {} }; 0 != (h.recipient + "").length && 0 != (h.endpointtype + "").length || console.log("error"); for (var q in g) "recipientUserId" != q && "endpointType" != q && (h.data[q] = g[q]); e[f] = h } 0 < e.length ? b.notificationsSend(e,
                c, d, null) : c && c()
        }
    }; _pio.notificationEndpoint = function (b, g, c, d) { this.type = b; this.identifier = g; this.configuration = c; this.enabled = d }
})();
(function () {
    _pio.publishingNetwork = function (b, g) {
        var c = this; this.profiles = new _pio.publishingNetworkProfiles(b); this.payments = new _pio.publishingNetworkPayments(b); this.relations = new _pio.publishingNetworkRelations(b, g, this); this.userToken = "[ERROR: you tried to access publishingNetwork.userToken before calling publishingNetwork.refresh(callback)]"; this.refresh = function (d, a) {
            b.socialRefresh(d, a, function (a) {
                c.userToken = a.myprofile.usertoken; c.profiles.myProfile = new _pio.publishingNetworkProfile(a.myprofile);
...
(function () {
    _pio.publishingNetworkProfiles = function (b) {
        this.myProfile = "[ERROR: you tried to access publishingNetworkProfiles.myProfile before calling publishingNetwork.refresh(callback)]"; this.showProfile = function (g, c) { _pio.showDialog("profile", b, { userId: g }, c) }; this.loadProfiles = function (g, c, d) {
            b.socialLoadProfiles(g, c, d, function (a) {
                for (var b = [], c = 0; c != g.length; c++) {
                    var d = g[c]; b[c] = null; for (var l = 0; l != a.profiles.length; l++) {
                        var k = a.profiles[l]; if (k && k.userid == d) {
                            b[c] = new _pio.publishingNetworkProfile(a.profiles[l]);
                            break
                        }
                    }
                } return b
    ...
    }; _pio.publishingNetworkProfile = function (b) { this.userId = b.userid; this.displayName = b.displayname; this.avatarUrl = b.avatarurl; this.lastOnline = new Date(b.lastonline); this.countryCode = b.countrycode }
})();
(function () {
    _pio.publishingNetworkRelations = function (b, g, c) {
        this.friends = "[ERROR: you tried to access publishingNetworkRelations.friends before calling publishingNetwork.refresh(callback)]"; this.isFriend = function (b) {
            if ("undefined" != typeof _pio.friendLookup && "undefined" != typeof _pio.friendLookup[g]) return _pio.friendLookup[g][b] || !1; throw new PlayerIOError(PlayerIOErrorCode.PublishingNetworkNotLoaded, "Cannot access profile, friends, ignored before Publishing Network has been loaded. Please refresh Publishing Network first");
            ...
            _pio.showDialog("requestblockuser",
                b, { userId: d }, function () { c.refresh(function () { a && a() }, function () { a && a() }) })
        }; this.showFriendsManager = function (d) { _pio.showDialog("friendsmanager", b, {}, function (a) { a.updated ? c.refresh(function () { d && d() }, function () { d && d() }) : d && d() }) }; this.showBlockedUsersManager = function (d) { _pio.showDialog("blockedusersmanager", b, {}, function (a) { a.updated ? c.refresh(function () { d && d() }, function () { d && d() }) : d && d() }) }
    }
})();
